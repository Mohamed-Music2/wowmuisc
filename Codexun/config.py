...
ASSID = int(getenv("ASSID", "16050450"))
ASSNAME = getenv("ASSNAME", "- 𝚃𝙰𝙴𝙼 𝙴𝙸𝚂𝙰 𝙼𝚄𝚂𝙸𝙲 ‹𝟹 .")
ASSUSERNAME = getenv("ASSUSERNAME", "lMl4ll_MUSIC")
...
OWNER_ID = int(getenv("OWNER_ID", "5191100896"))
UPDATE = getenv("UPDATE", "D_o_m_A12")
SUPPORT = getenv("SUPPORT", "BarEisa)
START_IMG = getenv("START_IMG", "https://telegra.ph/file/c8a6ebdfea3861c876134.jpg")
...
ASSISTANT_NAME = getenv("ASSNAME", "lMl4ll_MUSIC")
